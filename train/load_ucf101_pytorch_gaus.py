...
class UCF101DataLoader(Dataset):
    ...
    def __init__(self, name, clip_shape, batch_size, percent='20', use_random_start_frame=False):
      self._dataset_dir = '../data/UCF101/UCF101_Videos/'       # Path to UCF101 
    ...
    def get_det_annots_test_prepared(self):
        import pickle    
        with open('visual_annots.pkl', 'rb') as ts_rid:
