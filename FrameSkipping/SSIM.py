    ...
    for filename in os.listdir(input_folder):
        if filename.endswith(".avi"):
            ...
            while True:
                ...
                # Compute the Structural Similarity Index (SSI) between consecutive frames
                similarity_index, _ = ssim(prev_frame, frame_gray, full=True, win_size=win_size)
